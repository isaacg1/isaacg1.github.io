...
\vspace{16pt}
    ...
    Accepted for publication in \textit{Queueing Systems}.

    Isaac Grosof, Naifeng Zhang, Marijn Heule.
    ``Towards the shortest DRAT proof of the Pigeonhole Principle.''
    Accepted for publication in Pragmatics of SAT 2022.
    ...
    \textbf{Invited paper at STOC 2021 TheoryFest}
...
\section{\centerline{TALKS GIVEN}}
    ...
    YEQT 2021: \textit{Asymptotically Optimal Multiserver Scheduling}, invited speaker.

    SIGMETRICS 2019: \textit{Load Balancing Guardrails: Keeping Your Heavy Traffic on the Road to Low Response Times.}

    SIGMETRICS 2018: \textit{SRPT for Multiserver Systems.}
