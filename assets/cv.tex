...
\textbf{Ziyuan Wang}: IEMS PhD student. Began advising Spring 2024. Proposal: Spring 2025. \\
\textbf{Cameron Curtis}: IEMS PhD student, co-advised with Prof.~Seyed Irvani. Began advising Winter 2024. Proposal: Spring 2026. \\
\textbf{Heyuan Yao}: IEMS PhD student. Began advising Spring 2025. \\

\textbf{Sianna Perez}: Undergraduate student. Summer 2026-ongoing. \\
\textbf{Daniela Chang Kim}: Undergraduate student. Summer Undergraduate Research Grant (SURG) recipient. Summer 2026-ongoing. \\
\textbf{Jooyoung Oh}: Undergraduate student. SURG recipient. Summer 2026-ongoing. \\
\textbf{Bryan Yuen}: Undergraduate student. URAP recipient. Fall 2025-Spring 2026. \\
\textbf{Yanis Zain}: Undergraduate student. Summer 2025. \\
\textbf{Willow Kowalik}: Undergraduate student. Winter-Spring 2025.
\section{\centerline{HONORS}}
    \vspace{4pt}

2026 INFORMS JFIG Paper Competition finalist \\
2025 Cole-Higgins Award for Excellence in Teaching from the McCormick School of Engineering at Northwestern \\
2025 INFORMS Graduate Teaching Award from the IEMS Department at Northwestern \\
...
\section{\centerline{REFEREED PUBLICATIONS -- JOURNAL PAPERS}}
\vspace{16pt}
    \centerline{\href{https://isaacg1.github.io/publications/}{Link to my publications}}
    \centerline{Note: The primary name I use is Izzy, and I have also published under Isaac.}
    \centerline{Bold text indicates students I advise.}

    \textbf{Ziyuan Wang} and Izzy Grosof.
    ``Pareto-Optimal Scheduling in the Half-batch Multiserver-job Model''.
    Accepted to \textit{Performance Evaluation} as of June 2026.
    Conference version accepted to \textit{IFIP Performance}.

    Céline Comte and Isaac Grosof.
    ``Graph-Based Product Form''.
    \textit{Queueing Systems}, June 2026.\\
    Note: Joint first authors.

    Isaac Grosof and Hayriye Ayhan.
    ``Multiserver-job Response Time under Multilevel Scaling''.
    \textit{Probability in the Engineering and Information Sciences}, March 2026.

    % For expanded version: include journal name.
    Izzy Grosof and Daniela Hurtado-Lange.
    ``Outperforming Multiserver SRPT at All Loads''.
    Accepted to \textit{ACM SIGMETRICS} as of December 2025.
    Under expedited review at a journal as of January 2026.
    Received minor revision, resubmitted.
    ...
    \textit{Performance Evaluation}, March 2026.
    Conference version at \textit{IFIP Performance}, CWI, Amsterdam, NL, November 2025.

    Isaac Grosof, Siva Theja Maguluri, R. Srikant. ``Convergence for Natural Policy Gradient for a Family of Infinite-State Queueing MDPs''.
    \textit{Queueing Systems}, August 2025.
    ...
    Conference version at \textit{ACM SIGMETRICS}, Long Island, NY, June 2025.
    ...
    Conference version at \textit{ACM SIGMETRICS/IFIP Performance}, June 2024.
    ...
    Conference version at \textit{IFIP Performance 2023}, Chicago, IL, November 2023. \\
...
\section{\centerline{REFEREED PUBLICATIONS -- FULL-LENGTH ($\approx$ 20 PAGE) CONFERENCE PAPERS}}
\vspace{4pt}
...
\section{\centerline{REFEREED PUBLICATIONS -- SHORT ($\le$ 10 PAGE) CONFERENCE PAPERS}}
\vspace{16pt}

    \textbf{Ziyuan Wang}, Izzy Grosof.
    ``Product Forms in Closed Order Independent Queues''.
    Accepted to the MAMA workshop at SIGMETRICS 2026.

    Zhongrui Chen, \textbf{Heyuan Yao}, Izzy Grosof, Benjamin Berg.
    ...
    Isaac Grosof, Mor Harchol-Balter, Alan Scheller-Wolf. ``New Stability Results for Multiserver-job Models via Product-form Saturated Systems.''
    \textit{Workshop on Mathematical Performance Modeling and Analysis (MAMA 2023)}. Orlando, FL, June 2023.
...
\section{\centerline{PAPERS UNDER SUBMISSION}}
    \vspace{16pt}
% For expanded version: Include journal name.
    \textbf{Heyuan Yao}, \textbf{Willow Kowalik}, and Izzy Grosof.
    ...
    Daniel Hurtado-Lange and Izzy Grosof.
    ``Markov Modulated JSQ in Heavy Traffic Via the Poisson Equation''. \\
    Received major revision, revising.

    \textbf{Ziyuan Wang} and Isaac Grosof.
    ...
    Received major revision, resubmitted.

    Runhan Xie, Ziv Scully, Isaac Grosof.
    ``Optimal Multiserver Scheduling under General Service Constraints in Heavy Traffic''. \\
    Submitted, awaiting initial review.

% \section{\centerline{PAPERS UNDER REVISION}}
%     \vspace{16pt}
% For expanded version: Include target journal

\section{\centerline{TECHNICAL REPORTS \& OTHER NONREFEREED PUBLICATIONS}}
    \vspace{4pt}
    \textbf{Daniela Chang Kim}, Izzy Grosof.
    ``Queueing Sim.''
    An open-source discrete-event simulator for single-server queueing policies.
    \url{https://crates.io/crates/queueing-sim}.
...
\textbf{Winter 2026}: Teaching IEMS 464, Advanced Queueing Theory.
Second-year graduate-level course,
advanced topics in queueing theory and scheduling theory.
Quality of instruction rated as 6/6 (2026).

\textbf{Winter 2025, '26}: Teaching IEMS 460-1, Stochastic Processes I.
First-year graduate-level course,
proof-based look at Markov chains and Poisson processes.
Quality of instruction rated as 5.75/6 (2025), 5.39/6 (2026).
Student review: ``This course was amazing! I learned a lot and the instructor clearly knew what they were doing and organized the class really well, which definitely added to my comprehension of the course." \\
\textbf{2025 INFORMS Graduate Teaching Award from the IEMS Department at Northwestern.}

\textbf{Fall 2024, '25}: Taught IEMS 315, Stochastic Models. Junior-senior level undergrad course,
covering Markov chains and Poisson processes.
Quality of instruction rated as 5.77/6 (2024), 5.40/6 (2025).
...
\textbf{Recipient of the 2025 Cole-Higgins Award for Excellence in Teaching from the McCormick School of Engineering at Northwestern.} \\
\textbf{Nominated for the Northwestern Canvas Hall of Fame},
for Best Use of Lecture Videos/Recordings.
...
\section{\centerline{EXTERNAL SERVICE}}
    \vspace{4pt}
    Applied Probability Trust Editorial Board Member, 2026-present
    ...
    TPC member for ACM SIGMETRICS/IFIP Performance 2024, '25, '26. \\
...
\section{\centerline{DEPARTMENTAL SERVICE}}
\vspace{4pt}
    \textbf{2026}: IEMS Seminars co-organizer.

    \textbf{Winter 2025}: IEMS Graduate Committee member,
    proposing changes to graduate curiculum to increase student flexibility.

\section{\centerline{PRE-FACULTY LEADERSHIP \& SERVICE}}
\vspace{4pt}
    ...
    \textbf{2022 - 2023}: Founding member of CMU CSD PhD Student Council,
...
\section{\centerline{TALKS GIVEN}}
    ...
    Panel speaker on supporting trans researchers. October 2024.
...
Pyth is one of the best programming languages for code golfing, i.e. solving tasks with the shortest possible programs. Available at \url{https://github.com/isaacg1/pyth}
