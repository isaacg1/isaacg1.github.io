...
\section{\centerline{PAPERS UNDER SUBMISSION OR REVISION}}
    ...
    Isaac Grosof and Hayriye Ayhan. ``Multiserver-job Response Time under Multilevel Scaling''. Under submission.

    \textbf{Ziyuan Wang} and Isaac Grosof. ``Novel Lower Bounds on M/G/k Scheduling''. Under revision.

    Céline Comte and Isaac Grosof. ``Graph-Based Product Form''. Under revision. \\
