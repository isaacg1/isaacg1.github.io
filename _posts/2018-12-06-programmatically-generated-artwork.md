...
I have made twenty-four Rust programs for programmatically generating artwork in different styles.
...
This art associates each pixel with a circle-center. It then generates a random color and finds the most similar color already placed.
It then follows the circle generated by that pixel and its circle center to find an open pixel.
The new pixel's circle center is tweaked slightly and stored.
If no open pixel is found, the pixel is placed randomly and a wide range of circle centers are allowed.

[Repository](https://github.com/isaacg1/spinning)

![Rainbow programmatic art. Big brushstrokes sweeping circularly from bottom left to top right and vice-versa, as well as many smaller circles.](/assets/art/spinning.png)
