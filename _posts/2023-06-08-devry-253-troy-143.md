...
I'm going to do a fresh, second-by-second count-through of the game for this blog post,
working exclusively off the [recording](https://www.youtube.com/watch?v=zWEMDwJPNU4)
posted by "kip SMITHERS".
I will write up, in the final section of this post, an exhaustive account of the game:
Every basket made, every shot taken, every time the announcers said the score,
every time the scoreboard was visible.
Once I've done that, I'll give the definitive result in the summary section below.

It's entirely possible that I'll make mistakes too.
...
* 55:37: Announcer: "And its the combination of the player's number and fouls, so its a multicolored 200."
